      ...
      <header class="">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-7 col-lg-3 text-center">
            <a href="tel: 15209558534" class="text-dark"><i class='bx bx-phone-outgoing fs-5 contactIcon'></i> <strong class="text-success">Llámenos</strong><br> +1 520-955-8534</a>
          </div>
  ...
  <main id="main">   
    ...
    <section id="pricing" class="pricing section-bg pb-5">
      <div class="container-fluid bg-main pt-5 text-center banner">
        <h1 class="display-5 text-light mainFont animate__animated animate__bounceInDown">Listos, en sus marcas, vamos al internet!</h1>
      ...
      <div class="container-fluid bg-main mt-5 pt-5 text-center banner2">
        <h2 class="display-5 text-light mainFont">Listos, en sus marcas, a vender en internet!</h2>
        <p class="mb-4 fs-4 text-white-50">Empieza a generar ventas 24/7 con tu propia tienda en internet</p>        
      </div>
      <div class="container up">
        <div class="row">
          <div class="col-xl-3 col-md-6">
